...
def pre_tournament_predictions_archive():
    """
    ...
    for event in events:
        ...
        if not df.empty:
            ...
            df = event_df
        df.to_csv("../../data/data_golf_pre_tournament_predictions_archive.csv")


def historical_outrights():
    ...
    all_event_df.to_csv("../../data/data_golf_historical_betting.csv")


def historical_dfs_data():
    """Collects the data from the Historical Outrights on data golf."""
    events = _get_events_list()
    ...
    for event in events:
        ...
        if not all_event_df.empty:
            ...
            all_event_df = event_df
        print("All Event DF", all_event_df.shape)
    all_event_df.to_csv("../../data/data_golf_historical_dfs.csv")
